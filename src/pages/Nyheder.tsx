...
export default function Nyheder() {
  const { data, loading, error } = useDB<Article[]>("article/section/nyheder");
  ...
  return <>
    {
      ...
      <section className="landing_header sport">
        ...
        <SenesteNews endpoint={"article/section/nyheder"}/>

        <Video thumbnail1="news_1.jpg" thumbnail2="news_2.jpg" />
      </section>
    }
  </>
}
