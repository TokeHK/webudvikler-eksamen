import VejrComponent from '../components/PageComponents/VejrComponent'
import useDB from '../hooks/useDB'
import type { Article } from './Landingpage'
import calcTime from '../hooks/calcTime'
import { Link } from 'react-router'
import VejrVideo from '../components/PageComponents/VejrVideo'

const Vejr = () => {
  const { data, loading, error } = useDB<Article[]>(`article/section/vejr`);
